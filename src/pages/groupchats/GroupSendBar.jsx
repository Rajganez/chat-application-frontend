...
import { UPLOAD_FILE } from "../../api/constants.js";

const GroupSendBar = () => {
  //State to send the payload to the server
  ...
  const handleAttachmentChange = async () => {
    try {
      ...
      if (file) {
        ...
        const response = await clientAPI.post(UPLOAD_FILE, formData, {
